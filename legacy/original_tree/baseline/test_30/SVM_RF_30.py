...
def run_ml():
    ...
    print("\n馃尣 Running Random Forest (n=100)...")
    ...
    print(f"鉁?RF Results: L1={l1 * 100:.1f}% | L4={l4 * 100:.2f}%")




    print("\n馃搻 Running SVM (Linear)...")
    ...
    print(f"鉁?SVM Results: L1={sl1 * 100:.1f}% | L4={sl4 * 100:.2f}%")

    print("\n" + "=" * 50)
    print("馃搳 Final ML Baselines Report (30 Set)")
    print("=" * 50)
