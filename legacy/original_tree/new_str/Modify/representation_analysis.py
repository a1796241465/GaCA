...
"""
Representation Quality Analysis for GaCA
- Silhouette Score
- Davies-Bouldin Index
- Linear Probing Accuracy

Addresses Reviewer uRQ4 M2: "quantitative representation analysis"
"""
...
def extract_features(model, dataloader):
    """Extract fusion features from model"""
    model.eval()
...
def compute_clustering_metrics(features, labels, sample_size=5000, random_state=42):
    ...
    Note: These metrics are expensive for large datasets, so we sample
    """
...
def linear_probing(train_features, train_labels, test_features, test_labels, max_iter=1000):
    """
    Train a linear classifier on frozen features and evaluate
    """
...
def compare_with_raw_embeddings(train_ds, test_ds, le):
    """Compare GaCA features vs raw ESM-2/ESM-IF1 embeddings"""
...
def plot_feature_analysis(results, out_dir):
    """Generate visualization of representation quality"""
