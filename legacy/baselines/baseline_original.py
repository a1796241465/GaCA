...
TRAIN_PKL = '/home/lihaotian/new_ec/Training_sequences_only/1225_v1_train_seq_embeddings_esm2.pkl'
TEST_PKL = '/home/lihaotian/new_ec/Training_sequences_only/1225_v1_test_seq_embeddings_esm2.pkl'
...
def load_data_gpu(pkl_path, csv_path, filter_ids=None):
    ...
    if not os.path.exists(pkl_path): return None, None
...
if filter_ids: print(f"✅ 已加载 {len(filter_ids)} 个核心样本 ID")
